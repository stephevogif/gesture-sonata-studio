...
export const Route = createFileRoute("/studio")({
  head: () => ({
    meta: [
      { title: "Seven Heavens — STEPH EVO'S HEAVEN SYNTH" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Seven Heavens — Accordi con i gesti | STEPH EVO'S HEAVEN SYNTH" },
      {
        property: "og:description",
        content: "Modalità accordi: gradi di scala, maggiore/minore ed espressione in tempo reale.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://gesture-sonata-studio.lovable.app/studio" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Seven Heavens — Accordi con i gesti | STEPH EVO'S HEAVEN SYNTH" },
      {
    ...
    links: [
      { rel: "canonical", href: "https://gesture-sonata-studio.lovable.app/studio" },
